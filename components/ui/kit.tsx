...
export function Select({ label, value, options, onChange, placeholder = 'Select…' }: {
  ...
  return (
    <View style={k.field}>
      ...
      {/* The backdrop is inert on purpose: a tap beside the card — or on the
          card's own title, which a plain View lets bubble up — used to dismiss
          the picker mid-form. Closing is the ✕ or the Android back button. */}
